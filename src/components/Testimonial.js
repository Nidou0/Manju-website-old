...
import { fatchData, wowJsAnimation } from "../utilits";
...
const Testimonial = () => {
  ...
  useEffect(() => {
    const fetchDataAsync = async () => {
      try {
        const result = await fatchData("/static/testimonial.json");
        setData(result);
        wowJsAnimation(); // Call wowJsAnimation after content changes
      } catch (error) {
    ...
    <div className="dizme_tm_section">
      <div className="dizme_tm_testimonials">
        <div className="dizme_tm_main_title" data-align="center">
          ...
          <p>
            Unlocking Leadership Potential, Empowering Youth, and Lifeline Game Changer
          </p>
        </div>
          ...
          <div className="total">
            <div className="in">
              <Swiper {...props} className="">
                {data &&
                  data.map((data, i) => (
                    <SwiperSlide key={i} className="wow">
                      <div className="icon">
                        <svg
